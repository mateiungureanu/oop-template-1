...
int main() {
    ...
    if(tasta==1) {
        ...
        for (int i=0;i<cinemauri[0].getNrFilme(); ++i)
			std::cout<< i+1 << "." << cinemauri[0].getFilmeDifuzate()[i].getNumeFilm() << " (" <<  cinemauri[0].getFilmeDifuzate()[i].getRating() <<")\n";
    ...
    if(tasta==2) {
		...
		if(tasta==3) {
			...
			std::cout<<"Ati selectat "<<nouFilm<< " (" << cinemauri[0].getFilmeDifuzate()[index].getRating() << " -> " << nouRating << ").";
			cinemauri[0].schimbaRating(nouFilm, nouRating);
			if (index != -1 && cinemauri[0].getFilmeDifuzate()[index].getRating() != cinemauri[1].getFilmeDifuzate()[index].getRating()) {
